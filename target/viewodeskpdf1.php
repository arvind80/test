...
if(!empty($_POST['dept']) && isset($_POST['dept'])){
	...
	if($_POST['dept']!='all'){
		...
		$StatusReport->getPdfData($_POST['dept'],$_POST['start_date_odesk'],$_POST['end_date_desk'],'odesk');
	}else{
	...
	$pdf->SetHeaderData('logo.png', PDF_HEADER_LOGO_WIDTH, ucwords($departmentName).' Report in period', 'http://www.kindlebit.com');
