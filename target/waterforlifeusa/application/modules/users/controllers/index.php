<?php
require_once dirname ( dirname ( __FILE__ ) ) . '/config/vars.php';
...
class Index extends Controller {
	...
	function index() { 
		...
		$primarycontent = $this->load->module_view ( $module_vars ['module_dir_name'], 'index' );
	...
	function register() {
		...
		if ($this->validation->run () == FALSE) {
			...
			$primarycontent = $this->load->module_view ( $module_vars ['module_dir_name'], 'register' );
		} else {
			$register = array ( );
			...
			$primarycontent = $this->load->module_view ( $module_vars ['module_dir_name'], 'register_done' );
	...
	function captcha() {
		...
		//exit;
		$captcha = imagecreatefromjpeg ( $module_vars ['module_basepath_static'] . "captcha.jpg" );
