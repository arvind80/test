...
if (strval ( $shop_currency ) != 'USD') {
	$this->cart_model->currencyChangeSessionData ( "USD" );
	/*	switch (strtolower ( USER_COUNTRY )) {
		
		case 'uk' :
			
			//$this->cart_model->currencyChangeSessionData ( "GBP" );
			$this->cart_model->currencyChangeSessionData ( "USD" );
		...
		default :
			...
			//	$this->cart_model->currencyChangeSessionData ( "EUR" );
			$this->cart_model->currencyChangeSessionData ( "USD" );
