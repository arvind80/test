	...
	function ajax_json_get_orders() {
		...
		if ($_POST ['oper'] == 'del') {
			...
			foreach ( $items as $item ) {
				...
				if (trim ( $item ['bemailaddress'] ) != '') {
					$s .= "<cell>" . $item ['bemailaddress'] . "</cell>";
				} else {
					
					$s .= "<cell>" . $item ['semailaddress'] . "</cell>";
				}
				if (trim ( $item ['scountry'] ) != '') {
				$s .= "<cell>" . $item ['scountry'] . "</cell>";
				} else {
					$s .= "<cell>" . $item ['bcountry'] . "</cell>";	
				}
			...
			if (trim ( $item ['bstate'] ) != '') {
				$s .= "<cell>" . $item ['bstate'] . "</cell>";
					...
					$s .= "<cell>" . $item ['sstate'] . "</cell>";	
				}
				
			if (trim ( $item ['bzipcode'] ) != '') {
				$s .= "<cell>" . $item ['bzipcode'] . "</cell>";
				} else {
					$s .= "<cell>" . $item ['szipcode'] . "</cell>";	
				}
				
				if (trim ( $item ['baddress1'] ) != '') {
				$s .= "<cell>" . $item ['baddress1'] . "</cell>";
				} else {
					$s .= "<cell>" . $item ['saddress1'] . "</cell>";	
				}
