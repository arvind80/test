<? $form_id = date("Y-m-d H:i:s"); $form_id = md5($form_id); ?>

<script type="text/javascript"> 
        $(document).ready(function() { 
            $('#form_<? print $form_id; ?>').ajaxForm(function() { 
               // alert("Thanks!"); 
...
<form action="<? print site_url('admin/content/menus_edit_small') ?>/id:<?php print $form_values['id'] ;  ?>" id="form_<? print $form_id; ?>" method="post" enctype="multipart/form-data">
    <h1>Add/Edit menu</h1>
