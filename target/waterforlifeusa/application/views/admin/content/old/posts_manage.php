          ...
          <table class="tablesorter tables" id="sortedtable" cellspacing="0" cellpadding="0">
            ...
            <tbody id="the_content_items_container">
              ...
              <tr id="content_row_id_<? print $item['id']; ?>">
                <!-- ID -->
                <td style="display: none"><? print $item['id']; ?><a href="<? print $this->content_model->contentGetHrefForPostId($item['id']) ; ?>" target="_blank" ><img src="<?php print_the_static_files_url() ; ?>admin/icons/silk/page_go.png"  border="0" alt=" " /></a>
                ...
                <td style="display: none"><? 	$temp= $this->content_model->commentsGetForContentId( $item['id']); print (count(  $temp )); ?>
                </td>
                ...
                <td class="visibleCell"><div class="cont_image" style="background-image: url('<? print   $thumb = $this->content_model->contentGetThumbnailForContentId($item['id'], 150); ?>')"></div>
