...
<div class="ullist">
  <? 
//content_helpers_getCaregoriesUlTree($content_parent, $link = false, $actve_ids = false, $active_code = false, $remove_ids = false, $removed_ids_code = false) {
...
<? if(($form_values['content_subtype'] == 'module')) :   ?>
...
<? $modules  = $this->core_model->plugins_getLoadedPlugins (); ?>
<select name="subtype_change_set_form_value" id="subtype_change_set_form_value">
<option value="">None</option>
<? foreach($modules as  $k => $v): ?>
<option value="<? print $k ?>"><? print $k ?></option>
<? endforeach; ?>
</select>
<? endif; ?>