...
<a href="<? print site_url($this->uri->uri_string()); ?>/edit:<?php print $item['id'] ;  ?>">edit</a>&nbsp;|&nbsp;<a href="<? print site_url($this->uri->uri_string()); ?>/delete:<?php print $item['id'] ;  ?>">delete</a>
<?
...
<table border="1" width="100%">
  ...
  <tr id="menu_item_id_<?php print $menu_item['id'] ;  ?>">
    ...
    <td><a href="<? print site_url($this->uri->uri_string()); ?>/index/move_up:<?php print $menu_item['id'] ;  ?>">up</a></td>
    <td><a href="<? print site_url($this->uri->uri_string()); ?>/index/move_down:<?php print $menu_item['id'] ;  ?>">down</a></td>
