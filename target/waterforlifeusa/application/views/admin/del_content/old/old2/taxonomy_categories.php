...
<table border="1" width="100%">
  ...
  <tr>
    ...
    <td><a href="<? print $this->uri->uri_string(); ?>/category_edit:<?php print $item['id'] ;  ?>">edit</a></td>
    <td><a href="<? print $this->uri->uri_string(); ?>/delete_category_item:<?php print $item['id'] ;  ?>">delete</a></td>
  </tr>
  <? // endforeach ;  ?>
</table>
<? endif; ?>-->
...
<form id="catform" action="<? print $this->uri->uri_string(); ?>" method="post" enctype="multipart/form-data">
  <div id="tabs">
    <ul class="tabs">
    ...
    <div id="tab2"><? include_once ('geodata_map.php') ; ?></div>
  </div>
</form>
