...
//document.onkeypress = stopRKey;
 ...
 ?>
  ...
  map = new GMap2(document.getElementById("google_map_holder"), { size: new GSize(<? print $geodata['geodata_map_width'] ?>,<? print $geodata['geodata_map_height'] ?>) } );
 
 
 var start = new GLatLng(<?php print $geodata ['geodata_mapcenter_lat']; ?>,<?php print $geodata ['geodata_mapcenter_lng']; ?>);
  map.setCenter(start, <? print $geodata ['geodata_mapzoom'] ; ?>);
 ...
 */
 ...
 <? if (strval($geodata ['geodata_maptype']) != '')  : ?>
	 <? if ((strval($geodata ['geodata_maptype']) != 'G_NORMAL_MAP') and (strval($geodata ['geodata_maptype']) != 'G_SATELLITE_MAP')
 ...
 map.addMapType(<? print $geodata ['geodata_maptype']; ?> ) ;
 <? else: ?>
 <?  $geodata ['geodata_maptype'] = 'G_PHYSICAL_MAP'; ?>
 <? endif; ?>
...
// alert(<? print intval($geodata ['geodata_mapzoom']);     ?>); 
map.setZoom(<? print intval($geodata ['geodata_mapzoom']);     ?>);
...
<option value="G_NORMAL_MAP" <? if($geodata ['geodata_maptype'] == 'G_NORMAL_MAP') : ?>  selected="selected"  <? endif ?>>G_NORMAL_MAP</option>
<option value="G_SATELLITE_MAP" <? if($geodata ['geodata_maptype'] == 'G_SATELLITE_MAP') : ?>  selected="selected"  <? endif ?>>G_SATELLITE_MAP</option>
<option value="G_HYBRID_MAP" <? if($geodata ['geodata_maptype'] == 'G_HYBRID_MAP') : ?>  selected="selected"  <? endif ?>>G_HYBRID_MAP</option>
<option value="G_PHYSICAL_MAP" <? if($geodata ['geodata_maptype'] == 'G_PHYSICAL_MAP') : ?>  selected="selected"  <? endif ?>>G_PHYSICAL_MAP</option>
<option value="G_MAPMAKER_NORMAL_MAP" <? if($geodata ['geodata_maptype'] == 'G_MAPMAKER_NORMAL_MAP') : ?>  selected="selected"  <? endif ?>>G_MAPMAKER_NORMAL_MAP</option>
<option value="G_MAPMAKER_HYBRID_MAP" <? if($geodata ['geodata_maptype'] == 'G_MAPMAKER_HYBRID_MAP') : ?>  selected="selected"  <? endif ?>>G_MAPMAKER_HYBRID_MAP</option>
<option value="G_MOON_ELEVATION_MAP" <? if($geodata ['geodata_maptype'] == 'G_MOON_ELEVATION_MAP') : ?>  selected="selected"  <? endif ?>>G_MOON_ELEVATION_MAP</option>
 <option value="G_MOON_VISIBLE_MAP" <? if($geodata ['geodata_maptype'] == 'G_MOON_VISIBLE_MAP') : ?>  selected="selected"  <? endif ?>>G_MOON_VISIBLE_MAP</option>
<option value="G_MARS_ELEVATION_MAP" <? if($geodata ['geodata_maptype'] == 'G_MARS_ELEVATION_MAP') : ?>  selected="selected"  <? endif ?>>G_MARS_ELEVATION_MAP</option>
<option value="G_MARS_VISIBLE_MAP" <? if($geodata ['geodata_maptype'] == 'G_MARS_VISIBLE_MAP') : ?>  selected="selected"  <? endif ?>>G_MARS_VISIBLE_MAP</option>
<option value="G_MARS_INFRARED_MAP" <? if($geodata ['geodata_maptype'] == 'G_MARS_INFRARED_MAP') : ?>  selected="selected"  <? endif ?>>G_MARS_INFRARED_MAP</option>
 <option value="G_SKY_VISIBLE_MAP" <? if($geodata ['geodata_maptype'] == 'G_SKY_VISIBLE_MAP') : ?>  selected="selected"  <? endif ?>>G_SKY_VISIBLE_MAP</option>

 <option value="G_SATELLITE_3D_MAP" <? if($geodata ['geodata_maptype'] == 'G_SATELLITE_3D_MAP') : ?>  selected="selected"  <? endif ?>>G_SATELLITE_3D_MAP</option>

 <option value="G_DEFAULT_MAP_TYPES" <? if($geodata ['geodata_maptype'] == 'G_DEFAULT_MAP_TYPES') : ?>  selected="selected"  <? endif ?>>G_DEFAULT_MAP_TYPES</option>

 <option value="G_MAPMAKER_MAP_TYPES" <? if($geodata ['geodata_maptype'] == 'G_MAPMAKER_MAP_TYPES') : ?>  selected="selected"  <? endif ?>>G_MAPMAKER_MAP_TYPES</option>
<option value="G_MOON_MAP_TYPES" <? if($geodata ['geodata_maptype'] == 'G_MOON_MAP_TYPES') : ?>  selected="selected"  <? endif ?>>G_MOON_MAP_TYPES</option>
<option value="G_MARS_MAP_TYPES" <? if($geodata ['geodata_maptype'] == 'G_MARS_MAP_TYPES') : ?>  selected="selected"  <? endif ?>>G_MARS_MAP_TYPES</option>
<option value="G_SKY_MAP_TYPES" <? if($geodata ['geodata_maptype'] == 'G_SKY_MAP_TYPES') : ?>  selected="selected"  <? endif ?>>G_SKY_MAP_TYPES</option>
...
<label><span>geodata note: </span><textarea name="geodata_note" cols="5" rows="10"><?php print $geodata ['geodata_note']; ?></textarea></label> 
  <label><span>geodata_mapcenter_lat: </span><input name="geodata_mapcenter_lat" type="text" id="geodata_mapcenter_lat" value="<?php print $geodata ['geodata_mapcenter_lat']; ?>" /></label>     <label><span>geodata_mapcenter_lng: </span><input name="geodata_mapcenter_lng" type="text" id="geodata_mapcenter_lng" value="<?php print $geodata ['geodata_mapcenter_lng']; ?>" /></label>  <?
