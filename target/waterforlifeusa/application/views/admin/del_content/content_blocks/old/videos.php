...
$.post("<? print site_url('admin/media/contentMediaVideosList') ?>/to_table:table_content/queue_id:"+media_upload_queue_vid+"/to_table_id:"+to_table_id1+"/random_stuff:"+Math.random(), function(data){
...
$("#videos_upload_progressbar").progressbar({
	...
	function do_yui_upload() {
		...
		uploader.uploadAll("<? print site_url('admin/media/mediaUploadVideos') ?>/to_table:table_content/queue_id:"+media_upload_queue_vid, "POST", null, "Filedata");
