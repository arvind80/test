<? require_once (ADMINVIEWSPATH.'content/pages/blocks/_start.php')  ?>
  ...
  <tr>
    ...
    <td valign="top"><div id="side-content-wrapper">
        <div id="side-content">
          ...
          <div class="objtabs" id="uitab1">
            <? require_once (ADMINVIEWSPATH.'content/pages/blocks/content_and_url.php')  ?>
   ...
   <!--       <div class="objtabs" id="uitab2">
          ...
          <div class="objtabs" id="uitab3">
             <? require_once (ADMINVIEWSPATH.'content/pages/blocks/basic_settings.php')  ?>
          </div>
          
           <div class="objtabs" id="uitab4">
             <? require_once (ADMINVIEWSPATH.'content/pages/blocks/menus.php')  ?>
          </div>
          
          <div class="objtabs" id="uitab5">
             <? require_once (ADMINVIEWSPATH.'content/pages/blocks/meta_tags.php')  ?>
          </div>
...
<? require_once (ADMINVIEWSPATH.'content/pages/blocks/_end.php')  ?>
