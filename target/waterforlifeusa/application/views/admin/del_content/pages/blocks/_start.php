...
<form id="content_form_object" action="<? print site_url($this->uri->uri_string()); ?>" method="post" enctype="multipart/form-data" class="pull obj_pages_form">

  <input name="id" type="hidden" id="id" value="<?php print $form_values['id']; ?>">
    <input name="media_queue_pictures" type="hidden" id="media_queue_pictures" value="<?php print $form_values['id']; ?>_<? print $this->session->userdata('session_id'); ?>_media_queue_pictures">
  <input name="media_queue_files" type="hidden" id="media_queue_files" value="<?php print $form_values['id']; ?>_<? print $this->session->userdata('session_id'); ?>_media_queue_files">
