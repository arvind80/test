...
<table cellpadding="0" cellspacing="0">
  ...
  <tr>
  <td width="20px"><input style="position: relative;top:2px;*top:0px;" name="menus[]" type="checkbox" <?php if($is_checked  == true): ?> checked="checked"  <? endif; ?> value="<?php print $item['id'] ?>" />
    </td>
