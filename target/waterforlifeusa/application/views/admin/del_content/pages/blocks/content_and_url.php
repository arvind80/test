...
if (document.getElementById("content_url_demo_holder") != null){
					...
					if($("#content_url").hasClass("disabled") == true){
									$.post("<? print site_url('ajax_helpers/content_GenerateUniqueUrlTitleFromContentTitle') ?>", {
...
<small class="urlt">url: </small>      <span id="content_url_demo_holder"><? print site_url() ?></span>

<input name="content_url"
                 id="content_url" type="text"  value="<?php print $form_values['content_url']; ?>"
                 <? if($form_values['content_url'] == ''): ?> class="disabled"  <? endif; ?>
