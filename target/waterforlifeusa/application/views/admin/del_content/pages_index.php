  ...
  <table border="0" width="100%" style="padding-left: 74px">
    <tr valign="top" style="vertical-align:top">
      <td width="300" style="vertical-align:top"><a onclick="tree.showall('#c311')" class="btn" href="javascript:;">Open All</a> <a onclick="tree.hideall('#c311')" class="btn" href="javascript:;">Hide All</a>
        ...
        <?
	 $link = site_url('admin/content/pages_edit/id:'). '{id}';
	 ...
	 ?>
        <div class="ooyes_ul_pages_tree_container" id="c311" style="float: left;clear: both" treeparams='<? print $tree_params_string;  ?>'></div>
        ...
        <a class="bgb" href="<? print site_url('admin/content/pages_edit/id:0') ?>">Create new page</a></td>
          ...
          <tbody id="the_content_items_container">
            ...
            <tr id="content_row_id_<? print $item['id']; ?>">
              ...
              <td><? print($item['content_title']) ; ?>
                ...
                <? endif;  ?></td>
              <td><a href="<? print site_url($item['content_url']) ; ?>" target="_blank"><? print($item['content_url']) ; ?></a></td>
              <td><? print($item['content_filename']) ; ?></td>
             <!-- <td><? print($item['is_active']) ; ?></td>-->
              <td><? print($item['updated_on']) ; ?></td>
              <td><? if($item['content_subtype'] == 'blog_section') : ?>
              ...
              <td><a class="btn red" href="javascript:deleteContentItem(<? print $item['id']; ?>, 'content_row_id_<? print $item['id']; ?>')">Delete</a></td>
            </tr>
            <? endforeach ?>
          </tbody>
        </table></td>
