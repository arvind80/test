...
<form id="catform" action="<? print site_url($this->uri->uri_string()); ?>" method="post" enctype="multipart/form-data">
  <div id="taxonomy_tabs">
    ...
    <div id="tab1" class="lbl_object">
      ...
      <textarea name="taxonomy_description" cols="" rows=""><? print $form_values['taxonomy_description'] ;  ?></textarea>
      </label>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><a href="#TB_inline?height=500&width=505&inlineId=tagCloudhiddenModalContent&modal=false" id="tagCloudhiddenModalContent_controller"    class="thickbox"><img src="<?php print_the_static_files_url() ; ?>/icons/tag_blue_edit.png" alt=" " border="0">Edit tags</a><br />
            <textarea name="taxonomy_tags_csv" id="taxonomy_tags_csv" wrap="virtual"  style="width:400px; padding:0px; height:60px; overflow:scroll;" cols="10" rows="10"><? print $thetags; ?></textarea></td>
        </tr>
      </table>
      <br />
      <br />
			...
			$("#deleteContentItem_dialog").dialog({
				...
				buttons: {
					'Delete!': function() {
						 ...
						 $(this).dialog('close');
						window.location.href='<? print site_url('admin/content/taxonomy_categories_delete/id:'); ?>' + $id;
  ...
  $(document).ready(function(){
    $("#categories_tree").treeview(
				...
				//control:"#sidetreecontrol",
				 persist: "cookie",
   cookieId: "navigationtree_<? print md5(uri_string() ) ; ?>"
