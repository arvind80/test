...
<?php endif; ?>
<!-- Load TinyMCE --> 
<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/mce_old/jquery.tinymce.js"></script> 
<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/mce_old/plugins/tinybrowser/tb_tinymce.js.php"></script>
...
$(selector).tinymce({
			...
			script_url : '<?php print_the_static_files_url() ; ?>js/mce_old/tiny_mce.js',
