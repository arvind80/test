...
<ul>
  ...
  <li <?php if( $className == 'comments')  : ?> class="active" <?php endif; ?> ><a href="<?php print site_url('admin/comments/index')  ?>"><img src="<?php print_the_static_files_url() ; ?>icons/comments.png"  border="0" alt=" " />Comments
    ...
    <?php endif;  ?>
      ...
      <li <?php if( $className == 'orders')  : ?> class="active" <?php endif; ?> ><a href="<?php print site_url('admin/orders')  ?>">Orders</a></li>
        <li  ><a  target="_blank" href="http://waterforlifeusa.com/aff/merchants/" title="user: info@waterforlifeusa.com pass:alderin123" >Affiliates</a></li>
