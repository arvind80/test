...
//Code for paypal return response.
//tx=2WD672995S208233A&st=Pending&amt=2025.36&cc=USD&cm=&item_number=
...
<form action="http://waterforlifeusa.com/ajax_helpers/saveOrderByCheck" class="validate show-error-fields" id="step2" method="post">
  ...
  $(document).ready(function(){
      $("#shipping_state").val("<? print $this->session->userdata ( 'shipping_state' ) ?>");
				...
				</div><h2 class="xblue-title-small">Please Enter Your Check Details Here</h2>
				<div class="mtf">
					<label>Check Number<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="checkNumber"
							id="checkNumber"
							value=""
				...
				<div class="mtf">
					<label>Bank Name<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="bank_name"
							id="bank_name"
							value=""
							class="required" type="text" />
					</div>
				...
				<div class="mtf">
					<label>Bank Address<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="bank_address"
							id="bank_address"
							value=""
							class="required" type="text" />
					</div>
				...
				<div class="mtf">
					<label>Bank State<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="bank_state"
							id="bank_state"
							value=""
							class="required" type="text" />
					</div>
				...
				<div class="mtf">
					<label>Bank City<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="bank_city"
							id="bank_city"
							value=""
							class="required" type="text" />
					</div>
				...
				<div class="mtf">
					<label>Bank Zip-Code<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="bank_zip_code"
							id="bank_zip_code"
							value=""
							class="required" type="text" />
					</div>
				...
				<div class="mtf">
					<label>Bank Phone Number<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="bank_phone_number"
				...
				<div class="mtf">
					<label>Account Holder Name<small class="pink_text"></small> </label>
					<div class="box">
						<input onblur="populateBillingInfo();" name="payee_name"
							id="payee_name"
							value=""
							class="required" type="text" />
					</div>
		 ...
		 <a class="btn" href="javascript:void(0);"><input class="btnright" type="submit" value="Submit !"></a>
</form>
<?}?></div>
		</div></div>
