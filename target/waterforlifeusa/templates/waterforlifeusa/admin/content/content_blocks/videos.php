...
$.post("<? print site_url('admin/media/contentMediaVideosList') ?>/to_table:table_content/queue_id:"+media_upload_queue_vid+"/to_table_id:"+media_pictures_to_table_id+"/random_stuff:"+Math.random(), function(data){
...
/*
var swfu_vids;
<? $user_data = ($this->session->userdata ( 'the_user' )); ?>
	  ...
	  upload_url : '<? print site_url('admin/media/mediaUploadVideos') ?>/to_table:table_content/queue_id:'+media_upload_queue_videos+'/to_table_id:'+media_videos_to_table_id,
	  flash_url : "<?php print_the_static_files_url() ; ?>js/swfupload/swfupload.swf?<?= rand() ?>",
	  flash9_url : "<?php print_the_static_files_url() ; ?>js/swfupload/swfupload_fp9.swf?<?= rand() ?>",
	 ...
	 file_types : "*.f4v;*.flv;",
	  ...
	  button_image_url : "<?php print_the_static_files_url() ; ?>js/swfupload/XPButtonUploadText_61x22.png?<?= rand() ?>",
	  button_width: 61,
	  button_height: 22,
	  custom_settings : {
...
*/
  ...
  <iframe frameborder="0" src="<? print site_url('admin/media/mediaUploadVideosIframe') ?>/to_table:table_content/queue_id:<?php print intval( $form_values['id']) ; ?>_<? print $this->session->userdata('session_id'); ?>_media_queue_videos/to_table_id:<?php print $form_values['id']; ?>" height="150" width="450" ></iframe>
  ...
  <!--
      ...
      <input name="media_queue_videos" type="hidden" id="media_queue_videos" value="<?php print intval( $form_values['id']) ; ?>_<? print $this->session->userdata('session_id'); ?>_media_queue_videos">
