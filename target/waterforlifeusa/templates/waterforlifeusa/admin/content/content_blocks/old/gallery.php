...
$.post("<? print site_url('admin/media/contentMediaPicturesList') ?>/to_table:table_content/queue_id:"+media_upload_queue_pic+"/to_table_id:"+to_table_id1+"/random_stuff:"+Math.random(), function(data){
...
//alert(ff2);
	...
	function pic_uploader_do_yui_upload() {
		...
		pic_uploader.uploadAll("<? print site_url('admin/media/mediaUploadPictures') ?>/to_table:table_content/queue_id:"+media_upload_queue_pic, "POST", null, "Filedata");
