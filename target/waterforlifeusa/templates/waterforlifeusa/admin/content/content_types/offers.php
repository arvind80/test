...
<div id="side-content-wrapper">
    ...
    <div id="tabsobj" style="position: absolute;top:-10000px">
      ...
      <? require_once (ADMINVIEWSPATH.'content/content_blocks/title_and_url_selector.php')  ?>
        ...
        <? require_once (ADMINVIEWSPATH.'content/content_blocks/offer_description.php')  ?>
      </div>
      ...
      <div class="objtabs" id="uitab5"><?  require_once (ADMINVIEWSPATH.'content/content_blocks/gallery.php')  ?></div>
       <!--<div class="objtabs" id="uitab6"><? // require_once (ADMINVIEWSPATH.'content/content_blocks/videos.php')  ?></div>-->
      <!--<div class="objtabs" id="uitab6"><? //require_once (ADMINVIEWSPATH.'content/content_blocks/other_options.php')  ?></div>-->
      <div class="objtabs" id="uitab7"><? require_once (ADMINVIEWSPATH.'content/content_blocks/offer_options.php')  ?></div>
