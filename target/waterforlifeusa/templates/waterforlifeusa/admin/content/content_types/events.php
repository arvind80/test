<? require_once (ADMINVIEWSPATH.'content/content_blocks/default_start.php')  ?>
  ...
  function(data){
    ...
    <script type="text/javascript">
	 $(document).ready(function(){
		...
		dateFormat: 'yy-mm-dd',
		<? if(strval($form_values['custom_fields']['event_start']) != ''): ?>
	 ...
	 $(document).ready(function(){
		...
		dateFormat: 'yy-mm-dd',
		<? if(strval($form_values['custom_fields']['event_end']) != ''): ?>
...
<br />
<? require_once (ADMINVIEWSPATH.'content/content_blocks/default_end.php')  ?>
