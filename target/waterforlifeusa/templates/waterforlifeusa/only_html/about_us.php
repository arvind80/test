<? include 'header.php' ?>
            ...
            <div id="content" class="gradient_top content-inner">
               ...
               <div id="main">
                  ...
                  <div class="gradient_top richtext">
                    <img src="img/demo/about_us.jpg" alt="" width="645px" style="display: block;margin: auto" />
...
<h2 class="blue-title" style="margin-bottom: 0px">Message from the president
</h2>
...
<div class="gradient_top cblock">
 <a href="#" class="prev-post">Company History</a>
 <a href="#" class="next-post">Certifications</a>
</div>
               ...
               <div id="sidebar">
                    <ul class="side-nav">
                       ...
                       <li class="active"><a href="#">About KYK</a></li>
