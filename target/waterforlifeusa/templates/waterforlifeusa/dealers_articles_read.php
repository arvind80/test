<div id="content" class="gradient_top content-inner"> <? print $this->content_model->getBreadcrumbsByURLAndPrintThem(); ?>
  ...
  <div id="main">
    ...
    <div class="news news-inner"> <a href="javascript:;" class="comments-number" onclick="scrollto('#the_comments_anchor')"><? print $this->comments_model->commentsGetCountForContentId($post['id']); ?> comments</a>
      <h2 class="blue-title-normal"><? print $post['content_title']; ?></h2>
      <div class="c"></div>
      <span class="date"><? print $post['created_on']; ?></span>
      <? $pictures = $this->content_model->contentGetPicturesFromGalleryForContentId($post['id'], '500');
      ...
      <div class="islide">
        <div class="islider">
          ...
          <a href="<? print $pictures[$i]; ?>"><img width="200" src="<? print $pictures_small1[$i]; ?>" alt="" /></a>
          <? $i++; endforeach; ?>
        </div>
