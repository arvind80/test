...
{	
	...
	if(strtoupper($SearchResult['L_TYPE']) == 'TRANSFER' || strtoupper($SearchResult['L_STATUS']) == 'UNCLAIMED')
	{
		...
		$Transfer['paypal_timezone'] = isset($SearchResult['L_TIMEZONE']) ? $SearchResult['L_TIMEZONE'] : '';
	...
	else
	{
		...
		$Transaction['paypal_timezone'] = isset($SearchResult['L_TIMEZONE']) ? $SearchResult['L_TIMEZONE'] : '';
