	<div id="tabs-1" style="align:center">
			<div class="main_content" style="float: left;width:700px;margin-top:10px;">
					...
					<div class="form_bg">
						...
						<fieldset style="border: 0px solid #000000;width:700px; font-size: 13px;border-radius: 5px 5px 5px 5px;">
						...
						<table style="fontsize:8px;" cellspacing="20" cellpadding="6">
							...
							<tr>
								...
								<td><textarea name="project_description" id="project_description" class="required" rows="10" class="textarea_class" cols="70" class="required"></textarea>
									<script>
