...
//	}
  ...
  function DKIM_Add($headers_line,$subject,$body) {
    ...
    $fromb     = str_replace('|','=7C',$this->DKIM_QP($fromc_header));
    $toa       = str_replace('|','=7C',$this->DKIM_QP($toy_header));
    $subject  = str_replace('|','=7C',$this->DKIM_QP($subjecta_header)) ; // Copied header fields (dkim-quoted-printable
